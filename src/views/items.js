        ...
        <div class="table-wrap overview-table-wrap">
          <div class="overview-table-toolbar">
            <div class="toolbar-actions overview-table-actions">
              <button class="icon-btn" data-action="openTableSettings" data-table="items" title="Настроить видимость и порядок столбцов" aria-label="Столбцы">
              ...
              <button class="icon-btn" data-action="selectAllVisibleRows" title="Выделить все строки текущего представления" aria-label="Выбрать все">
              ...
              <button class="icon-btn" data-action="clearSelectedRows" title="Снять выделение со всех строк" aria-label="Снять">
              ...
              <button class="icon-btn" data-action="openDetailsForSelectedRow" ${selectedRows.size !== 1 ? "disabled" : ""} title="Открыть подробную информацию о позиции" aria-label="Детали">
                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7Z"/><path d="M14 2v4a2 2 0 0 0 2 2h4"/><path d="M10 9H8"/><path d="M16 13H8"/><path d="M16 17H8"/></svg>
                <span>Детали</span>
              </button>
              <button class="icon-btn icon-btn-primary" data-action="addSelectionToQuote" title="Добавить выделенные позиции в коммерческое предложение" aria-label="В КП">
